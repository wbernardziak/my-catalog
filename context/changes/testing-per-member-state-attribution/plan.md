...
- [ ] 3.1 `npm run test:db` passes
- [ ] 3.2 Deleting either `.eq("member_id", …)` turns the suite red; restored afterwards
- [ ] 3.3 At least one case gives the two members opposing state on the same game
