...
**Amended 2026-09-14** (`context/changes/testing-guard-self-verification/research.md`).
...
| 6   | Guard self-verification             | Prove every guard and gate fails on a known-bad input and on an empty scan, tracks the installed tooling, and cannot be dropped from CI unnoticed                                 | #10           | unit self-tests over fixture trees + workflow/script wiring assertion + `bash -n` | complete    | `context/changes/testing-guard-self-verification/`                  |
