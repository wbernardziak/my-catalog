...
| 3   | Catalog integrity under soft-delete | Prove deleted games leave every read path but stay in storage, and filter composition never drops live games                                           | #6            | integration (query layer)               | change opened                    | `context/changes/testing-catalog-integrity-soft-delete/`           |
